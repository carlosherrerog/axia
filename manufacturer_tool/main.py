...
DEFAULTS = {
    ...
    "WATCH_NFT_ADDRESS":   "0x48F996eb99127A5858fb88670C0F670403B2a03D",
    "MARKETPLACE_ADDRESS": "0xAac2855fDc5fA3A3d81fEe442662E44f98985574",
    "USDC_ADDRESS":        "0xBF3B419496a24f94b0F4DD83bbccA501Bd9F8620",
}
    ...
    def _build(self):
        ...
        for icon, title, body in [
            ...
            ("☁️", "Pinata — almacenamiento de imágenes",
             "Cada fabricante tiene su propia cuenta en Pinata (pinata.cloud). Es como tener "
             "tu propio espacio en internet donde se guardan de forma permanente las imágenes "
             "y la ficha técnica de tus relojes. Crea tu cuenta gratuita en app.pinata.cloud "
             "y copia aquí tu API Key y Secret Key."),
            ("📦", "La colección AXIA — un único registro compartido",
             ...
             "oficial e inmutable donde cada reloj tiene un número único y queda grabado para "
             "siempre quién fue su fabricante. Cada NFT te pertenece a ti y lleva tus "
             "royalties asociados: cada vez que ese reloj se revenda recibirás automáticamente "
